...
#include "rp23xx_ina219.h"
#endif

#ifdef CONFIG_SENSORS_BMP180
#include <nuttx/sensors/bmp180.h>
#include "rp23xx_bmp180.h"
#endif

#ifdef CONFIG_SENSORS_BMP280
#include <nuttx/sensors/bmp280.h>
#include "rp23xx_bmp280.h"
#endif
...
#  endif
  ...
  if (ret < 0)
    {
      syslog(LOG_ERR, "ERROR: rp23xx_ina219_initialize() failed: %d\n", ret);
    }
#endif
  ...
  ret = sht4x_register("/dev/sht4x0", rp23xx_i2cbus_initialize(0),
